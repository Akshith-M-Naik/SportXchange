...
import 'successfulpayment_model.dart';
export 'successfulpayment_model.dart';
...
class _SuccessfulpaymentWidgetState extends State<SuccessfulpaymentWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xEB2FCD70),
        body: SafeArea(
          top: true,
          child: Align(
              ...
              children: [
                Align(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/Affirm_Success_Animation.gif',
