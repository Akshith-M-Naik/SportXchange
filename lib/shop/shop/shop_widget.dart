  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductRecord> shopProductRecordList = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Stack(
                children: [
                          ...
                          if (!FFAppState().searchactive)
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final nosearc =
                                      shopProductRecordList.toList();

                                  return SingleChildScrollView(
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: List.generate(nosearc.length,
                                          (nosearcIndex) {
                                        final nosearcItem =
                                            nosearc[nosearcIndex];
                                        return Container(
                                          height: 200.0,
                                                            ...
                                                            onPressed:
                                                              ...
                                                              await CartRecord
                                                                  ...
                                                                  .set(
                                                                    ...
                                                                    finalMrp: functions.quantityPrice(
                                                                        nosearcItem
                                                                            .mrp,
                                                                        1),
                                                                    mrp: nosearcItem
                  ...
                  Align(
                    alignment: AlignmentDirectional(1.04, 0.88),
                    child: Padding(
                      padding:
                          ...
                          context.pushNamed(
                            ...
                            queryParameters: {
                              'finalprice': serializeParam(
                                functions.finalprice(_model.queryCart!
                                    .map((e) => e.finalPrice)
                                    .toList()
                                    .sortedList(
                                        keyOf: (e) => e.toString(), desc: false)
                                    .toList()),
                                ParamType.double,
                              ),
                              'finalmrp': serializeParam(
                                functions.finalmrp(_model.queryCart!
                                    .map((e) => e.finalMrp)
                                    .toList()
                                    .sortedList(
                                        keyOf: (e) => e.toString(), desc: false)
