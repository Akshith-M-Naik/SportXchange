  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: Color(0x876908E7),
            body: Center(
              child: SizedBox(
                width: 50.0,
                height: 50.0,
        ...
        List<CartRecord> orderSummaryCartRecordList = snapshot.data!;
                                              ...
                                              options: FFButtonOptions(
                                                ...
                                                iconPadding:
                                                    EdgeInsetsDirectional
                                                        .fromSTEB(
                                                            0.0, 0.0, 0.0, 0.0),
                                                color: Color(0xC6FFF9F9),
                                                textStyle: FlutterFlowTheme.of(
                                                        context)
                                                    .titleSmall
                                                    .override(
                                                      fontFamily: 'Readex Pro',
                                                      color: Color(0xCD474545),
                                                      fontSize: 12.0,
                                                      letterSpacing: 0.0,
                                                    ),
                                                elevation: 3.0,
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  formatNumber(
                                    functions.totalAmount(widget!.lastprice!,
                                        functions.taxes(widget!.lastprice!)),
                                    formatType: FormatType.custom,
                                    currency: '₹',
                                    format: '',
                                    locale: '',
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.gen = await actions.orderGenerator();
                                _shouldSetState = true;
                                _model.apiResultzi5 =
                                    await CreatePaymnetOrdersCall.call(
                                  orderId: _model.gen,
                                  orderAmount: functions.totalAmount(
                                      widget!.lastprice!,
                                      functions.taxes(widget!.lastprice!)),
                                  orderCurrency: 'INR',
                                ...
                                _shouldSetState = true;
                                if ((_model.apiResultzi5?.succeeded ?? true)) {
                                  context.pushNamed(
                                    'Payment',
                                    queryParameters: {
                                      'paymentsessionid': serializeParam(
                                        CreatePaymnetOrdersCall
                                            .paymentsessionid(
                                          (_model.apiResultzi5?.jsonBody ?? ''),
                                        ),
                                        ParamType.String,
                                      ),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        CreatePaymnetOrdersCall.errormessage(
                                          (_model.apiResultzi5?.jsonBody ?? ''),
                                        )!,
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
